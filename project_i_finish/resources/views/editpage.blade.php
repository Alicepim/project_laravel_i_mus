...
@section('content')
 <div class="absolute">
    <h3 class="text-3xl font-medium text-gray-700 mt-1 ml-5">Edit Data Character</h3>
@if ($errors->any())
    ...
    <form action="{{route('upDateCharacter', $editData->id)}}" method="POST" class="mx-auto max-w-xl mt-6">
        @csrf
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <select name="race" id="race" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                        <option value="{{$editData->race}}">{{$editData->race}}</option>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <select name="class" id="class" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                        <option value="{{$editData->class}}">{{$editData->class}}</option>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="level" id="level" value="{{$editData->level}}"
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="strength" id="strength" value="{{$editData->strength}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="dexterity" id="dexterity" value="{{$editData->dexterity}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="constitution" id="constitution" value="{{$editData->constitution}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="intelligence" id="intelligence" value="{{$editData->intelligence}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="wisdom" id="wisdom" value="{{$editData->wisdom}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                ...
                <div class="mt-2.5">
                    <input type="number" name="charisma" id="charisma" value="{{$editData->charisma}}"
                        class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset shadow-blue-500 ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="mt-10">
